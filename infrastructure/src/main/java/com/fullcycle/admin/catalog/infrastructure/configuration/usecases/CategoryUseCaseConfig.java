...
import com.fullcycle.admin.catalog.application.category.retrieve.get.DefaultGetCategoryByIdByIdUseCase;
...
public class CategoryUseCaseConfig {
    ...
    @Bean
    public GetCategoryByIdUseCase categoryByIdUseCase() {
        return new DefaultGetCategoryByIdByIdUseCase(categoryGateway);
    }
